...
func NewSyncCondition(locker sync.Locker) *SyncCondition {
	return (*SyncCondition)(sync.NewCond(locker))
}
...
func NewSyncWaitGroup() *WaitGroup         { return (*WaitGroup)(&sync.WaitGroup{}) }
