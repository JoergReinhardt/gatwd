...
func (n NativeConst) Type() Typed {
	return Define(n().TypeNat().TypeName(), NewData(n().TypeNat()))
}

func (n NativeExpr) Call(args ...Expression) Expression { return n }
...
func (n NativeCol) Call(args ...Expression) Expression { return n }
...
func (n NativeCol) Type() Typed                        { return Define(n().TypeName(), NewData(n.TypeNat())) }
...
func (n NativeUbox) Call(args ...Expression) Expression { return n }
...
func (n NativeUbox) Type() Typed                        { return Define(n.Eval().TypeName(), NewData(n.TypeNat())) }
...
func (n NativePair) Call(args ...Expression) Expression { return n }
...
func (n NativeSet) Call(args ...Expression) Expression   { return n }
